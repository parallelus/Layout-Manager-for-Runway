...
<form action="<?php echo $this->self_url(); ?>&navigation=settings&action=update-settings" method="post">
	<h3><?php echo __('Layout Sections', 'runway'); ?></h3>
	<table class="form-table">
		<tbody>
			<tr class="">
				...
				<td>
					<label><input class="input-check" type="checkbox" value="true" name="headers" <?php echo (isset($settings['headers']) && $settings['headers'] == 'true') ? 'checked' : ''; ?>> <?php echo __('Enable Layout Headers', 'runway'); ?></label>
				</td>
			</tr>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
					<label><input class="input-check" type="checkbox" value="true" name="footers" <?php echo (isset($settings['footers']) && $settings['footers'] == 'true') ? 'checked' : ''; ?>> <?php echo __('Enable Layout Footers', 'runway'); ?></label>
				</td>
			</tr>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
					<label><input class="input-check" type="checkbox" value="true" name="other-options" <?php echo (isset($settings['other-options']) && $settings['other-options'] == 'true') ? 'checked' : ''; ?>> <?php echo __('Enable Layout Options', 'runway'); ?></label>
				</td>
			</tr>
		</tbody>
	</table>
	<h3><?php echo __('Layout Structure', 'runway'); ?></h3>
	<table class="form-table">
		<tbody>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
					<select id="grid-structure" class="input-select" name="grid-structure">
						<option value="bootstrap" <?php echo (isset($settings['grid-structure']) && $settings['grid-structure'] == 'bootstrap') ? 'selected="selected"' : ''; ?>><?php echo __('Bootstrap (default)', 'runway'); ?></option>
						<option value="960" <?php echo (isset($settings['grid-structure']) && $settings['grid-structure'] == '960') ? 'selected="selected"' : ''; ?>><?php echo __('960 Grid System', 'runway'); ?></option>
						<option value="unsemantic" <?php echo (isset($settings['grid-structure']) && $settings['grid-structure'] == 'unsemantic') ? 'selected="selected"' : ''; ?>><?php echo __('unsemantic', 'runway'); ?></option>
						<option value="custom" <?php echo (isset($settings['grid-structure']) && $settings['grid-structure'] == 'custom') ? 'selected="selected"' : ''; ?>><?php echo __('Custom', 'runway'); ?></option>
					</select>
			...
			<tr class="">
				<th scope="row" valign="top">
					<?php _e('Design width', 'runway') ?> <p class="description required"><?php echo __('Required', 'runway'); ?></p>
				</th>
				<td>
					<?php
			...
			<tr class="">
				<th scope="row" valign="top">
					<?php _e('Columns', 'runway') ?> <p class="description required"><?php echo __('Required', 'runway'); ?></p>
				</th>
				<td>
					<?php
			...
			<tr class="">
				<th scope="row" valign="top">
					<?php _e('Margins', 'runway') ?> <p class="description required"><?php echo __('Required', 'runway'); ?></p>
				</th>
				<td>
					<?php
			...
			<tr class="">
				<th scope="row" valign="top">
					<?php _e('Row Class', 'runway') ?> <p class="description required"><?php echo __('Required', 'runway'); ?></p>
				</th>
				<td>
					<?php
			...
			<tr class="">
				<th scope="row" valign="top">
					<?php _e('Column class format', 'runway') ?> <p class="description required"><?php echo __('Required', 'runway'); ?></p>
				</th>
				<td>
					<?php
	...
	<h3><?php echo __('Content Source Section', 'runway'); ?></h3>
	<table class="form-table">
		<tbody>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
                    <label><input class="input-check" type="checkbox" value="true" name="content-source-pages" <?php if((isset($settings['content-source-pages']) && $settings['content-source-pages'] === 'true')) { ?>checked<?php } ?>> <?php echo __('Enable Pages', 'runway'); ?></label>
				</td>
			</tr>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
					<label><input class="input-check" type="checkbox" value="true" name="content-source-posts" <?php if((isset($settings['content-source-posts']) && $settings['content-source-posts'] === 'true')) { ?>checked<?php } ?>> <?php echo __('Enable Posts', 'runway'); ?></label>
				</td>
			</tr>
			<tr class="">
				<th scope="row" valign="top">
				...
				<td>
					<label><input class="input-check" type="checkbox" value="true" name="content-source-sidebars" <?php if((isset($settings['content-source-sidebars']) && $settings['content-source-sidebars'] === 'true')) { ?>checked<?php } ?>> <?php echo __('Enable Sidebars', 'runway'); ?></label>
				</td>
			</tr>
<!-- 			<?php $static_block = get_pages(array('post_type' => 'static_block'));
			if (sizeof($static_block) > 0): ?>
				<tr class="">
					...
					<td>
						<label><input class="input-check" type="checkbox" value="true" name="content-source-static_block" checked> <?php echo __('Enable Static Blocks', 'runway'); ?></label>
					</td>
				</tr>
			<?php endif ?> -->
			 ...
			 isset($layouts_manager->layouts_manager_options['settings']['footers']) ): ?>
				...
				<div class="meta-box-sortables metabox-holder" data-template="${template}" data-index="${index}">
					<div class="postbox">
						...
						<?php if(isset($layouts_manager->layouts_manager_options['settings']['headers']) &&
			 					 isset($layouts_manager->layouts_manager_options['settings']['footers']) ): ?>
									<h3 class="postbox-title hndle"><span><?php _e('Rendering of Header and Footer', 'runway'); ?></span></h3>
						<?php endif; ?>
						<?php if(isset($layouts_manager->layouts_manager_options['settings']['headers']) &&
			 					 !isset($layouts_manager->layouts_manager_options['settings']['footers']) ): ?>
									<h3 class="postbox-title hndle"><span><?php _e('Rendering of Header', 'runway'); ?></span></h3>
						<?php endif; ?>
						<?php if(!isset($layouts_manager->layouts_manager_options['settings']['headers']) &&
			 					 isset($layouts_manager->layouts_manager_options['settings']['footers']) ): ?>
									<h3 class="postbox-title hndle"><span><?php _e('Rendering of Footer', 'runway'); ?></span></h3>
						<?php endif; ?>
						<div class="inside" >
							<?php if(isset($layouts_manager->layouts_manager_options['settings']['headers']) ):
								...
								<pre class="code sample-code">// <?php echo wordwrap(__('Begin Layout', 'runway')." do_action('output_layout','start');", 20); ?></pre>
							<?php endif; ?>
							<?php if(isset($layouts_manager->layouts_manager_options['settings']['footers']) ):
								...
								<pre class="code sample-code">// <?php echo wordwrap(__('End Layout', 'runway')." do_action('output_layout','end');", 20); ?></pre>
							<?php endif; ?>
						</div>
					</div>
				</div>
