<?php
global $layout_manager_admin;

if ( ! empty( $layout_manager_admin->navigation ) && ! in_array( $layout_manager_admin->navigation, array(
		'add-layout',
		'edit-layout'
	) )
) { ?>
	<table class="form-table">
		...
		<tr class="">
			...
			<td>
				<input class="input-text " type="text" name="footer-title" id="footer-title"
				       value="<?php echo isset( $footer['title'] ) ? esc_attr( $footer['title'] ) : ''; ?>">
			</td>
		</tr>
		</tbody>
	</table>
