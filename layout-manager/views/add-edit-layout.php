		...
		<div id="post-body-content">
			...
			<div>
				<div id="titlediv">
					...
					<div id="titlewrap">
						<label class="hide-if-no-js" style="visibility: hidden; " id="title-prompt-text" for="title"><?php _e('Enter title here', 'runway') ?></label>
				...
				<div id="HeaderWrapper">
					<div class="control-bar">
						...
						<div id="HeaderAddEdit">
							...
							<a href="#save_header" id="SaveHeader" class="button button-primary"><?php _e('Save', 'runway') ?></a>
							<a href="#cancel_edit_header" id="CancelEditHeader" class="button"><?php _e('Cancel', 'runway') ?></a>
						</div>
					</div>
				...
				<div id="GridWrapper">
					<div id="GridEnd" class="not-a-row">
						<a href="#add_row_button" id="AddNewRow" class="button button-hero"><?php _e('Add Row', 'runway') ?></a>
					</div>
				</div><!-- / #GridWrapper -->
				...
				<div id="FooterWrapper">
					<div class="control-bar">
						...
						<div id="FooterAddEdit">
							...
							<a href="#save_footer" id="SaveFooter" class="button button-primary"><?php _e('Save', 'runway') ?></a>
							<a href="#cancel_edit_footer" id="CancelEditFooter" class="button"><?php _e('Cancel', 'runway') ?></a>
						</div>
					</div>
				...
				<div id="RowTemplate">
					...
					<div class="rowWrapper">
						...
						<a href="#close" tabindex="2" class="delete-row ui-dialog-titlebar-close" title="<?php echo __('Delete Row', 'runway'); ?>" role="button"><span class="ui-icon ui-icon-closethick">close</span></a>
					</div><!-- / .rowWrapper -->
				...
				<div id="ColumnTemplate">
					...
					<div class="column">
						<div class="column-header">
							<a href="#desktop" id="desktop" class="responsive-visibility show-on desktop-view" title="<?php _e('Visible on Desktop', 'runway') ?>"></a>
							<a href="#tablet" id="tablet" class="responsive-visibility show-on tablet-view" title="<?php _e('Visible on Tablet', 'runway') ?>"></a>
							<a href="#phone" id="phone" class="responsive-visibility show-on phone-view" title="<?php _e('Visible on Phone', 'runway') ?>"></a>
							<a href="#close" class="delete-column ui-dialog-titlebar-close" tabindex="2" title="<?php echo __('Delete Column', 'runway'); ?>" role="button"><span class="ui-icon ui-icon-closethick">close</span></a>
						</div>
						<div class="content-element">
							<div class="handle"></div>
								<a href="#close" class="delete-element ui-dialog-titlebar-close" tabindex="2" title="<?php echo __('Delete Cell', 'runway'); ?>" role="button"><span class="ui-icon ui-icon-closethick">close</span></a>
								...
								<p class="content-type-help-text">
									<span class="spinner"></span>
									<span class="description-default_content"><?php _e('The default content of the area. <strong>This should exist only once in every layout.</strong>', 'runway') ?></span>
									<?php
									foreach($custom_post_types as $key => $custom_post_type) {
										$custom_post_type_label = isset($custom_post_type->label) ? $custom_post_type->label : "";
										if(count($custom_posts[$key]) > 0) {
								...
								<div class="secondary-select" style="display: none;">
									...
									<div class="check-override-secondary">
										<label><input class="input-check-secondary" type="checkbox" value="false" name="allow_override"><?php _e('Allow override on single pages', 'runway'); ?></label>
			...
			<div class="meta-box-sortables metabox-holder">
				<div class="postbox">
					...
					<div class="inside" >
						...
						?>
						<p>
							<button style="float:right;" id="save_structure" class="button-primary ajax-save"><?php _e('Save settings', 'runway'); ?></button>
							<span class="spinner"></span>
							<div class="clear"></div>
						</p>
						<script type="text/javascript">
