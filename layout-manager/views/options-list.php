...
<table class="wp-list-table widefat" style="margin-top: 15px;">
	...
	<?php if ( isset( $settings['headers'] ) ) { ?>
		<tr>
			<td class="row-title">
				<strong>
					<a href="themes.php?page=layout-manager&navigation=edit-options&option=headers">
				...
				<div class="row-actions">
					<span class="edit">
						<a href="themes.php?page=layout-manager&navigation=edit-options&option=headers" title="<?php _e( 'Edit this item', 'runway' ); ?>">
							<?php _e( 'Edit', 'runway' ); ?>
						</a>
					</span>
				</div>
	...
	if ( isset( $settings['footers'] ) ) { ?>
		<tr class="alt">
			<td class="row-title">
				<strong>
					<a href="themes.php?page=layout-manager&navigation=edit-options&option=footers">
				...
				<div class="row-actions">
					<span class="edit">
						<a href="themes.php?page=layout-manager&navigation=edit-options&option=footers" title="<?php _e( 'Edit this item', 'runway' ); ?>">
							<?php _e( 'Edit', 'runway' ); ?>
						</a>
					</span>
				</div>
	...
	if ( isset( $settings['other-options'] ) ) { ?>
		<tr>
			<td class="row-title">
				<strong>
					<a href="themes.php?page=layout-manager&navigation=edit-options&option=other-options">
				...
				<div class="row-actions">
					<span class="edit">
						<a href="themes.php?page=layout-manager&navigation=edit-options&option=other-options" title="<?php _e( 'Edit this item', 'runway' ); ?>">
							<?php _e( 'Edit', 'runway' ); ?>
						</a>
					</span>
				</div>
