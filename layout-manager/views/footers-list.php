				...
				foreach ($footers as $key => $values):
					...
					<tr class="<?php echo $trClass ?>">
						...
						<td class="column-description" style="text-align:right;">
							<a href="<?php echo $this->self_url('edit-footer'); ?>&alias=<?php echo $values['alias']; ?>"><?php _e('Edit', 'runway') ?></a> |
							<a style="color: #BC0B0B;" href="<?php echo $this->self_url(); ?>&navigation=confirm-delete-footer&alias=<?php echo $values['alias']; ?>"><?php _e('Delete', 'runway') ?></a>
						</td>
					</tr>
					<?php
					$count++;
