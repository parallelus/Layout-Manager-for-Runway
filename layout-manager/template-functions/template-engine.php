...
function template_context( $template ) {
	...
	global $context, $target_wp_template_file;
 ...
 * @param string | array $file_or_function - A single template file, array of template files or function to be called
...
function auto_register_wp_category_context() {
	...
	$category_ids = get_terms( 'category', array(
		'fields' => 'ids',
		'get'    => 'all'
	) ); // database look up of all categories
